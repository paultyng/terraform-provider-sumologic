...
func TestAccSumologicAzureEventHubLogSource_create(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSumologicAzureEventHubLogSourceConfig(cName, cDescription, cCategory, sName, sDescription, sCategory, testNamespace, testEventHub, testConsumerGroup, testRegion, testSASKeyName, testSASKey),
...
func TestAccSumologicAzureEventHubLogSource_update(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccSumologicAzureEventHubLogSourceConfig(cName, cDescription, cCategory, sNameUpdated, sDescriptionUpdated, sCategoryUpdated, testNamespace, testEventHub, testConsumerGroup, testRegion, testSASKeyName, testSASKey),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAzureEventHubLogSourceExists(azureEventHubLogResourceName, &azureEventHubLogSource),
...
func testAccSumologicAzureEventHubLogSourceConfig(cName, cDescription, cCategory, sName, sDescription, sCategory, testNamespace, testEventHub, testConsumerGroup, testRegion, testSASKeyName, testSASKey string) string {
	return fmt.Sprintf(`
...
`, cName, cDescription, cCategory, sName, sDescription, sCategory, testNamespace, testEventHub, testConsumerGroup, testRegion, testSASKeyName, testSASKey)
}
